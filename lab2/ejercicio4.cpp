...
{
	//EJECUTAR SOLO LA PRIMER BLOQUE 
	double matriz1[MAX][MAX];
	double matriz2[MAX][MAX];
	double matriz3[MAX][MAX];
...
int main()
{
	normalMatrixMultiplication(200,1);
	blockMatrixMultiplication(200,1,100);
	cout<<"****************************************************************************************************+\n";
}